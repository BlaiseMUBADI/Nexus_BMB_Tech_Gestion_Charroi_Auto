...
public class DatabaseManager {
    ...
    private static boolean insertSampleData() {
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            // Données véhicules
            String insertVehicules = """
                INSERT IGNORE INTO vehicule (matricule, marque, type, annee, disponible, date_assurance, date_vidange, date_visite_technique)
                VALUES 
            ...
            String insertUtilisateurs = """
                INSERT IGNORE INTO utilisateur (nom, role, mot_de_passe_hash)
                VALUES 
            ...
            String insertAffectations = """
                INSERT IGNORE INTO affectation (vehicule_id, conducteur_id, date_debut, date_fin, motif, statut)
                VALUES 
            ...
            // Données entretiens
            String insertEntretiens = """
                INSERT IGNORE INTO entretien (vehicule_id, date_entretien, type_entretien, commentaire, statut)
                VALUES 
